...
Class MailchimpPostNotify {
     ...
     * @param string $api
     * @return \MailchimpPostNotify|null
     * @since 3.0
     */
    ...
    public static function GetList($mcSession, $listid) {
        if ($mcSession):
            ...
            if (is_array($list)):
                error_log("List $listid not found in MailchimpPostNotify::GetList. " . print_r($list, true));
                return;
            endif;
            return $list;
        endif;
     ...
     * @since 3.20170201
     * @param MailchimpPostNotify $mcSession
     * @param string $type
     * @param string $listid
    ...
    public static function CampaignCreate($mcSession, $type, $listid, $settings, $interestCategory = "", $interest = "") {
        if ($mcSession):
            ...
            if ($interestCategory !== ""):
                if ($interest === ""):
                    error_log("Campaign creation failed in MailchimpPostNotify::CreateCampaing. InterestId cannot be null.");
                    return;
                endif;
                $segment_opts               = array(
                    "match"      => "any",
            ...
            if (is_array($campaign)):
                error_log("Campaign creation failed in MailchimpPostNotify::CreateCampaing. " . print_r($campaign, true));
                return;
            endif;
            return $campaign->id;
        endif;
